...
export class AppComponent {
  ...
  alumnoArray: Alumno[] = [
      {id: 1, name: 'Alex', lastname: 'Campos', age: 35 , direccion: 'COlonia El mirador' , telefono: 22222, email: 'blablabla'},
      {id: 2, name: 'Maria', lastname: 'Lopez', age: 20 , direccion: 'COlonia El mirador' , telefono: 2204278, email: 'blablabla'},
      {id: 3, name: 'Juan', lastname: 'Castro', age: 25, direccion: 'COlonia El mirador' , telefono: 2204278, email: 'blablabla'}


   ];
// atributo selecAlumno del tipo Alumno, por lo tanto, puede almacenar un objeto
  selectedAlumno: Alumno = {id: 0, name: '', lastname: '', age: 0 , direccion: '', telefono: 0 , email: '' };
...
// de lo contrario limpia el atributo selectedAlumno en pantalla. [(ngModel)]
  addOrEdit(): void
    ...
    this.selectedAlumno = {id: 0, name: '', lastname: '', age: 0 , direccion: '', telefono: 0 , email: '' };
    }
